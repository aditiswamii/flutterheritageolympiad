...
/// data : {"user":{"id":75,"name":"Neo","age_group":"Group 4","country":"India","flag_icon":"http://3.108.183.42/flags/in.png","status":"Online","image":"http://3.108.183.42/storage/images/O6aa2UMYgRlkE8eXtaV1NerehMBnnqbprao7ewwd.jpg"},"contact":{"id":74,"name":"Neoaditi","age_group":"Group 4","country":"Armenia","flag_icon":"http://3.108.183.42/flags/am.png","status":"Online","image":"http://3.108.183.42/storage/images/rxkhZOqdfQVdavN6DcUYHtRxWYi1ZxpL2cNAtZJV.jpg"},"is_friend":1,"your_league":{"league_id":5,"league_name":"Initiate"}}

GetContactProfileResponse getContactProfileResponseFromJson(String str) => GetContactProfileResponse.fromJson(json.decode(str));
String getContactProfileResponseToJson(GetContactProfileResponse data) => json.encode(data.toJson());
class GetContactProfileResponse {
  ...
  GetContactProfileResponse.fromJson(dynamic json) {
    _status = json['status'];
...
/// contact : {"id":74,"name":"Neoaditi","age_group":"Group 4","country":"Armenia","flag_icon":"http://3.108.183.42/flags/am.png","status":"Online","image":"http://3.108.183.42/storage/images/rxkhZOqdfQVdavN6DcUYHtRxWYi1ZxpL2cNAtZJV.jpg"}
/// is_friend : 1
