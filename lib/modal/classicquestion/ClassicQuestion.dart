...
ClassicQuestion classicQuestionFromJson(String str) => ClassicQuestion.fromJson(json.decode(str));
String classicQuestionToJson(ClassicQuestion data) => json.encode(data.toJson());
class ClassicQuestion {
  ...
  ClassicQuestion.fromJson(dynamic json) {
    _status = json['status'];
