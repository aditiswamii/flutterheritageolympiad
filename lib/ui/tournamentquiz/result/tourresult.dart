...
class _State extends State<TournamentResult> {
  ...
  getTourResult(String userid, int tourid, int sessionId) async {
  ...
  onsuccess(resultdata) {
    ...
    if (resultdata != null && resultdata.toString().isNotEmpty) {
      ...
      print("gettourjsonsuccess$tourresultr");
      print("gettourjsonsuccessuser${tourresultr[0]['percentage']}");
    } else {
                                              ...
                                              return Container(
                                                  ...
                                                  child: GFProgressBar(
                                                    ...
                                                    progressBarColor: int.parse(
                                                        ...
                                                        ? ColorConstants
                                                            .stage1color
                                                        : int.parse(tourresultr['result'][index]['percentage'].toString()) <
                                                                49
                                                            ? ColorConstants
                                                                .stage2color
                                                            : int.parse(tourresultr['result'][index]['percentage'].toString()) ==
                                                                ...
                                                                : int.parse(tourresultr['result'][index]['percentage'].toString()) <
                                                                    ...
                                                                    : int.parse(tourresultr['result'][index]['percentage'].toString()) <
                                                                        ...
                                                                        : int.parse(tourresultr['result'][index]['percentage'].toString()) <= 100
                                                        ...
                                                        Container(
                                                          ...
                                                          child: tourresultr['result']
                                                              ...
                                                              : CircleAvatar(
                                                                  radius: 30.0,
                                                                  backgroundImage:
                                                                      NetworkImage(tourresultr['result'][index]
                                                                              [
                                                                              'image']
                                                                          .toString()),
                                                                  backgroundColor:
                        ...
                        Column(
                          children: [
                            GestureDetector(
                              onTap: () {
                                Share.share(
                                    "I got ${tourresultr['user_data']['xp'].toString()} XP on Cultre App. you can play on https://play.google.com/store/apps/details?id=$packagename",
                                    subject: 'Share link');
                              },
                              child: Container(
                                  alignment: Alignment.center,
