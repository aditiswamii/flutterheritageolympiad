                                                      ...
                                                      children: [
                                                        Container(
                                                          alignment: Alignment
                                                              .centerLeft,
                                                          child: Text(
                                                            "${getTourRoomlistt!.data![index].name}",
                                                            style: const TextStyle(
                                                                color:
                                                                    ColorConstants
                                                                        .txt,
                                                          ...
                                                          child: Row(
                                                            children: [
                                                              if (getTourRoomlistt!
                                                                  ...
                                                                  .isNotEmpty)
                                                                Text(
                                                                  "${getTourRoomlistt!.data![index].ageGroup}",
                                                                  style: const TextStyle(
                                                                ...
                                                                children: [
                                                                  ...
                                                                  if (getTourRoomlistt!
                                                                    ...
                                                                    Container(
                                                                      ...
                                                                      child:
                                                                          Text(
                                                                        "${getTourRoomlistt!.data![index].country}",
                                                                        style: const TextStyle(
                ...
                child: Row(
                  ...
                  children: [
                    ...
                    ElevatedButton(
                      ...
                      onPressed: () {
                        exittour(userid.toString(), widget.tourid!,
                            widget.sessionid!);
                      },
                      child: const Text(
                        "EXIT WAITROOM",
