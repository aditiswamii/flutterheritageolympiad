...
import '../classicquiz_main.dart';

void main() {
  runApp(const MaterialApp(
    debugShowCheckedModeBanner: false,
    home: ClassicModeLink(),
  ));
}

class ClassicModeLink extends StatefulWidget {
  const ClassicModeLink({Key? key}) : super(key: key);

  @override
  _State createState() => _State();
}

class _State extends State<ClassicModeLink> {
                    ...
                    ElevatedButton(
                      ...
                      onPressed: () {
                        Navigator.pushReplacement(
                            context,
                            MaterialPageRoute(
                                builder: (context) => const ClassicModeSelectPlayer()));
                      },
                      child: const Text(
                        "LET'S GO!",
                        style: TextStyle(
