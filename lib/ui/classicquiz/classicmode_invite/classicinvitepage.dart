...
class ClassicInvite extends StatefulWidget {
  const ClassicInvite({Key? key}) : super(key: key);

  @override
  _State createState() => _State();
}

class _State extends State<ClassicInvite> {
                        ...
                        child: GestureDetector(
                            onTap: () {
                              Navigator.pushReplacement(
                                  context,
                                  MaterialPageRoute(
                                      builder: (context) => const ClassicModeLink()));
                              // Navigator.pushReplacement(
                              //     context,
                              //     MaterialPageRoute(
