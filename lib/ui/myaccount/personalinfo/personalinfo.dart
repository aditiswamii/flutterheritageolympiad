  ...
  uploadFile(
    ...
    request.send().then((response) {
      ...
      if (response.statusCode == 200) {
        ...
        // Navigator.pop(context);
        if (kDebugMode) {
          print("uploadfile response:${response.statusCode}");
        }
      }
    });
  }

  profileupdateapi(String userid, String mobile, String firstName, String dob,
      String stateId, String cityId, String gender, String lastName) async {
    http.Response response = await http
        .post(Uri.parse('${StringConstants.BASE_URL}update-profile'), body: {
    ...
    if (response.statusCode == 200) {
      ...
      // Navigator.pop(context);
      if (kDebugMode) {
        print("profileupdate:${response.statusCode}");
      }
    }
  }
                                                      ...
                                                      children: [
                                                        Container(
                                                          ...
                                                          child:
                                                            ...
                                                            onTap: () {
                                                              setState(() {
                                                                countryname = jsonDecode(datacoun!)['countries']
                                                                            [
                                                                            index]
                                                                        ['name']
                                                                    .toString();
                                                                countryid = jsonDecode(
                                                                            datacoun!)['countries']
                                                                        [
                                                                        index]['id']
                                                                    .toString();
                                                      ...
                                                      children: [
                                                        Container(
                                                          ...
                                                          child:
                                                            ...
                                                            onTap: () {
                                                              setState(() {
                                                                statename = jsonDecode(datastate!)['states']
                                                                            [
                                                                            index]
                                                                        ['name']
                                                                    .toString();
                                                      ...
                                                      children: [
                                                        Container(
                                                          ...
                                                          child:
                                                            ...
                                                            onTap: () {
                                                              setState(() {
                                                                cityname = jsonDecode(citydata!)['cities']
                                                                            [
                                                                            index]
                                                                        ['name']
                                                                    .toString();
