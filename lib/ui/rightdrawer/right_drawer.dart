        ...
        child: ListView(
          children: [
            ListTile(
              ...
              trailing:
                  Image.asset("assets/images/cross.png", height: 20, width: 20),
              onTap: () {
            ...
            ListTile(
              ...
              title: const Text(
                'My Account',
                style: TextStyle(fontSize: 18, color: ColorConstants.menu_text),
                ...
                Navigator.pushReplacement(
                    ...
                    MaterialPageRoute(
                        builder: (context) => AboutUsPage(
                              title: 'ABOUT US',
                              url: 'https://www.cultre.in/our-team',
                            )));
            ...
            ListTile(
              title: const Text(
                ...
                style: TextStyle(
                    fontSize: 18,
                    color: ColorConstants.menu_text,
