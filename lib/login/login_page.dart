...
import 'package:flutterheritageolympiad/login/login_viewmodal.dart';
                ...
                Container(
                  ...
                  child: Card(
                    ...
                    child: ListTile(
                      ...
                      minLeadingWidth: 30,
                      trailing: Image.asset("assets/google_plus.png", width: 20,
                          height: 20,
                          alignment: Alignment.center,
                          color: ColorConstants.Omnes_font),
                      title: Text('Sign in with Google',
                          style: TextStyle(fontSize: 15, color: ColorConstants
                              .Omnes_font,)),
                      onTap: () {
                ...
                Container(
                  ...
                  child: Card(
                    ...
                    child: ListTile(
                      ...
                      minLeadingWidth: 30,
                      trailing: Image.asset("assets/facebook.png", width: 20,
                          height: 20,
                          alignment: Alignment.center,
                          color: ColorConstants.Omnes_font),
                ...
                Container(
                  ...
                  child: Card(
                    ...
                    child: ListTile(
                      ...
                      minLeadingWidth: 30,
                      trailing: Image.asset("assets/twitter.png", width: 20,
                          height: 20,
                          alignment: Alignment.center,
                          color: ColorConstants.Omnes_font),
                      title: Text('Sign in with Twitter',
                          style: TextStyle(fontSize: 15, color: ColorConstants
                              .Omnes_font,)),
                      onTap: () {
                        // Navigator.pushReplacement(context,
